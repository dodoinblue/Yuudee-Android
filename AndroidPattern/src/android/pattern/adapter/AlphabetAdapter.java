...
public class AlphabetAdapter<T extends AlphabetInfo> extends BaseAdapter implements SectionIndexer {
    private Context ct;
    private List<T> data;

    public AlphabetAdapter(Context ct, List<T> datas) {
        this.ct = ct;
        this.data = datas;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(ct).inflate(
                            R.layout.item_user_friend, parent, false);
